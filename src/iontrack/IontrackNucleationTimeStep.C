...
#include "IontrackNucleationTimeStep.h"
#include "DiscreteNucleationInserterBase.h"
#include "MooseUtils.h"

registerMooseObject("PhaseFieldApp", IontrackNucleationTimeStep);

InputParameters
IontrackNucleationTimeStep::validParams()
{
...
IontrackNucleationTimeStep::IontrackNucleationTimeStep(const InputParameters & parameters)
...
PostprocessorValue
IontrackNucleationTimeStep::getValue()
{
